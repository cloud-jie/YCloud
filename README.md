> <H3>这是我严格意义上的第一款工具，从 2022 年初立项到如今的重构发布，跨越了四年的时光，它记录了我从行业新人到开发者的成长。</H3>
...
使用时与展示的有所不同，但核心功能没有变化。

仓库中 target.txt 文件内为作者使用的翻译节点，可直接导入使用，导入方式为：

顶级菜单Ycloud -> 翻译节点管理 -> 导入节点中填入 -> 点击导入并测速 即可
